...
class AccountStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subscription_state'] === null) {
            $invalidProperties[] = "'subscription_state' can't be null";
        }
     ...
     *
     * @param string $subscription_plan The subscription plan currently associated with the account, or 'none'.
     *
     * @return self
     */
     ...
     *
     * @param string $subscription_state The current subscription state: 'active', 'pastDue', or 'ended'.
     *
     * @return self
     */
     ...
     * Sets credits
     *
     * @param float $credits The number of API credits left. Can be fractional, so parse as a double-precision number.
     *
     * @return self
     */
